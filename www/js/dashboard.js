...
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/dashnewveri.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/dashinprogress.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/dashverified.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/dash_not_verified.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/completed.php?region='+region,
  data:$('#newt').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
