     ...
     // alert(a);
      ...
      if (k == 0 ){
       ...
       // alert(one+'oneempeeeducation');
        $('.document_imag_inproone_veric_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
      ...
      if (k == 1 ){
        ...
        //alert(oneo+'two');
        $('.document_imag_inproone_verid_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 2 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_verib_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 3 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_veria_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 4 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_verie_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 5 ){
        var oneo=oneemploy[k];
       // alert(oneo+'two');
        $('.document_imag_inproone_verif_c').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 0 ){
  ...
  $('.document_imag_inproone_veric_c').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.document_imag_inproone_verid_c').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 2 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verib_c').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 3 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_veria_c').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 4 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verie_c').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
