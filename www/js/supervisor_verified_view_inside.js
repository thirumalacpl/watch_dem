     ...
     // alert(a);
      ...
      if (k == 0 ){
       ...
       // alert(one+'oneempeeeducation');
        $('.document_imag_inproone_veric').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
      ...
      if (k == 1 ){
        ...
        //alert(oneo+'two');
        $('.document_imag_inproone_verid').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 2 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_verib').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 3 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_veria').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 4 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        $('.document_imag_inproone_verie').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

      }
      if (k == 5 ){
        var oneo=oneemploy[k];
       // alert(oneo+'two');
        $('.document_imag_inproone_verif').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//  $('.document_imag_veri').append('<img class="profile-thumbnail" src="http://thewatchguard.com/alpha/uploads/'+oneemp+'" style="width:150px;height:150px">&nbsp;');
...
if (j == 0 ){
  ...
  $('.document_imag_inproone_veric').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.document_imag_inproone_verid').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 2 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verib').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 3 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_veria').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 4 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verie').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
//$('.document_imag_veri').append('<img class="profile-thumbnail" src="http://thewatchguard.com/alpha/documents/addressid/'+oneproof+'" style="width:150px;height:150px">&nbsp');
