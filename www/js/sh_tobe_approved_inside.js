...
$('.approved_shb').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneoo+'3');
$('.approved_shc').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
