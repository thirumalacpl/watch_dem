...
if ( j == 0){
  var one=oneemp[j];
//alert(one+'one');
$('.waiting_imagea').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 2){
  var oneoo=oneemp[j];
//alert(oneoo+'3');
$('.waiting_imagec').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
