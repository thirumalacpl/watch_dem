...
$.ajax({url: "http://thewatchguard.com/alpha/slim-cor/dash_sh_inprogress.php?region="+region+"&regionsection="+regionsection,
    data:$('#e').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
...
$.ajax({url: "http://thewatchguard.com/alpha/slim-cor/dash_tobeapproved_sh.php?region="+region,
    data:$('#ee').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
...
$.ajax({url: "http://thewatchguard.com/alpha/slim-cor/dash_completed_sh.php?region="+region,
    data:$('#ee').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
...
$.ajax({url: "http://thewatchguard.com/alpha/slim-cor/dash_waiting_sh.php?region="+region,
    data:$('#ee').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
