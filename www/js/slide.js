...
var oneemp=employimg_obj.document;
   ...
   $('#name_inpro').text(user_obja.name);
    ...
    $('.document_imag_inpro').append('<img class="profile-thumbnail" src="http://thewatchguard.com/alpha/uploads/'+oneemp+'" style="width:150px;height:150px">&nbsp;');
...
//alert(oneimg+'img id');
   ...
   // $('#address_inpro').text(currentobj_educational_records.address);
    ...
    $('.document_imag_inpro').append('<img class="profile-thumbnail" src="http://thewatchguard.com/alpha/documents/addressid/'+oneproof+'" style="width:150px;height:150px">&nbsp');
